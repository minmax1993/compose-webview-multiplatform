...
private fun PermissionRequestState.toDecision() = when(this) {
    PermissionRequestState.GRANTED -> WKPermissionDecision.WKPermissionDecisionGrant
    PermissionRequestState.DENIED -> WKPermissionDecision.WKPermissionDecisionDeny
}
